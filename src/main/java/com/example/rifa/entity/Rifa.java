...
public class Rifa {
    ...
    @Column(name = "codigo_vip_usado", length = 255)
    private String codigoVipUsado;
    ...
    public String getCodigoVipUsado() {
        return codigoVipUsado;
    }

    public void setCodigoVipUsado(String codigoVipUsado) {
        this.codigoVipUsado = codigoVipUsado;
    }
